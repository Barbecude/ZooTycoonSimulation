...
public class ShelfScreen extends AbstractContainerScreen<ShelfMenu> {
    ...
    private void renderSideInfo(GuiGraphics guiGraphics) {
        ...
        guiGraphics.drawString(font, "Food Shelf", panelX, panelY, 0xFFE6D2A2, false);
        guiGraphics.drawString(font, "Item: " + menu.getDisplayItemName(), panelX, panelY + 12, 0xFF55AA55, false);
        guiGraphics.drawString(font, "Stock: " + menu.getStock() + "/64", panelX, panelY + 24, 0xFFAAAAAA, false);
        guiGraphics.drawString(font, "Price: Rp " + menu.getPrice(), panelX, panelY + 36, 0xFFFFFFFF, false);
    }
}

    ...
    public static class ClientModBusEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            event.enqueueWork(() -> {
                ...
                net.minecraft.client.renderer.ItemBlockRenderTypes.setRenderLayer(IndoZooTycoon.RESTROOM_BLOCK.get(),
                        net.minecraft.client.renderer.RenderType.cutout());
            });
        }
                    ...
                    ctx -> {
                        var renderer = new HumanoidMobRenderer<VisitorEntity, HumanoidModel<VisitorEntity>>(
                            ...
                            public ResourceLocation getTextureLocation(VisitorEntity entity) {
                                if (entity.isHunter()) {
                                    return new ResourceLocation(IndoZooTycoon.MODID, "textures/entity/visitor/hunter.png");
                                }
